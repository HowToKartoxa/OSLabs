...
* With Ninja or Make you would need a sufficient build environment (again, VS is preffered, because it sets up this environment automatically) such as MSYS2 ucrt64.exe or mingw64.exe. Pass path to this environment as a c++ compiler when using cmake. Example - `cmake -G "Ninja" -DCMAKE_CXX_COMPILER=C:\msys64\ucrt64. ..` (when using VS 2022 you can just type `cmake ..`. It will find msvc compiler automatically).
